...
b58_dcmap  = '123456789abcdefghjklmnpqrstuvwxyz!)$(=/\.i;?"_o}{@+|*,: -~'
...
def generate (prefix_string, name):
    ...
    partly_padded_prefixed_name = prefixed_name.ljust(28,'1')
    # partly_padded_prefixed_name = prefixed_name
    # This seems to work as two sets, see comments below
    padded_prefixed_name = partly_padded_prefixed_name.ljust(34, '1')
